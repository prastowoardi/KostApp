...
export default function PaymentHistory() {
    ...
    const renderItem = ({ item }) => {
        ...
        return (
            <TouchableOpacity 
                style={[styles.card, { borderLeftColor: isPaid ? '#1cc88a' : '#e74a3b' }]}
                onPress={() => router.push({
            ...
            >
                <View style={styles.cardContent}>
                    ...
                    <View style={styles.rightInfo}>
                        <View style={[styles.statusBadge, { backgroundColor: isPaid ? '#f0fdf4' : '#fff1f2' }]}>
                            <Text style={[styles.statusText, { color: isPaid ? '#16a34a' : '#e11d48' }]}>
    ...
    if (loading) {
        return (
            <View style={styles.center}>
                ...
                <Text style={{ marginTop: 10, color: '#858796' }}>Memuat Riwayat...</Text>
            </View>
        );
    }
...
const styles = StyleSheet.create({
    ...
    statusBadge: { paddingVertical: 4, paddingHorizontal: 10, borderRadius: 8, marginBottom: 5 },
    statusText: { fontSize: 10, fontWeight: 'bold' },
    emptyBox: { alignItems: 'center', marginTop: 100 },
    emptyText: { color: '#b7b9cc', marginTop: 10, fontSize: 14, fontWeight: '500' }
});